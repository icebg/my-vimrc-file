...
set expandtab        " 假如是noexpandtab,就是不要将制表符tab展开成空格。expandtab 选项把插入的 tab 字符替换成特定数目的空格。具体空格数目跟 tabstop 选项值有关
...
" # <vim中常用折叠命令>   https://www.cnblogs.com/litifeng/p/11675547.html
"{{{
" -----------------------------------------------------------------------------
